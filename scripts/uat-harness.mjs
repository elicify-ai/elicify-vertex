...
if (section("A. Shipped artefact")) {
  ...
  // 8 since B-2 added `elicify_vertex_scope_amend` — the tool that makes the
  // scope-watchdog directive's "fold / amend / revert" offer actionable (and
  // its compliance measurable).
